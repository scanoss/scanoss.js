...
goog.exportSymbol('proto.scanoss.api.components.v2.CompStatistic', null, global);
goog.exportSymbol('proto.scanoss.api.components.v2.CompStatistic.Language', null, global);
goog.exportSymbol('proto.scanoss.api.components.v2.CompStatisticResponse', null, global);
goog.exportSymbol('proto.scanoss.api.components.v2.CompStatisticResponse.Purls', null, global);
 ...
 * @constructor
 */
proto.scanoss.api.components.v2.CompStatistic = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.scanoss.api.components.v2.CompStatistic.repeatedFields_, null);
};
goog.inherits(proto.scanoss.api.components.v2.CompStatistic, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.scanoss.api.components.v2.CompStatistic.displayName = 'proto.scanoss.api.components.v2.CompStatistic';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.scanoss.api.components.v2.CompStatistic.Language = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.scanoss.api.components.v2.CompStatistic.Language, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.scanoss.api.components.v2.CompStatistic.Language.displayName = 'proto.scanoss.api.components.v2.CompStatistic.Language';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.scanoss.api.components.v2.CompStatisticResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.scanoss.api.components.v2.CompStatisticResponse.repeatedFields_, null);
};
goog.inherits(proto.scanoss.api.components.v2.CompStatisticResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.scanoss.api.components.v2.CompStatisticResponse.displayName = 'proto.scanoss.api.components.v2.CompStatisticResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.scanoss.api.components.v2.CompStatisticResponse.Purls, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.scanoss.api.components.v2.CompStatisticResponse.Purls.displayName = 'proto.scanoss.api.components.v2.CompStatisticResponse.Purls';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.scanoss.api.components.v2.CompStatistic.repeatedFields_ = [4];
 ...
 * @return {!Object}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.toObject = function(opt_includeInstance) {
  return proto.scanoss.api.components.v2.CompStatistic.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.scanoss.api.components.v2.CompStatistic} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatistic.toObject = function(includeInstance, msg) {
  var f, obj = {
totalSourceFiles: jspb.Message.getFieldWithDefault(msg, 1, 0),
totalLines: jspb.Message.getFieldWithDefault(msg, 2, 0),
totalBlankLines: jspb.Message.getFieldWithDefault(msg, 3, 0),
languagesList: jspb.Message.toObjectList(msg.getLanguagesList(),
    proto.scanoss.api.components.v2.CompStatistic.Language.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.scanoss.api.components.v2.CompStatistic}
 */
proto.scanoss.api.components.v2.CompStatistic.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.scanoss.api.components.v2.CompStatistic;
  return proto.scanoss.api.components.v2.CompStatistic.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.scanoss.api.components.v2.CompStatistic} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.scanoss.api.components.v2.CompStatistic}
 */
proto.scanoss.api.components.v2.CompStatistic.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setTotalBlankLines(value);
      break;
    case 4:
      var value = new proto.scanoss.api.components.v2.CompStatistic.Language;
      reader.readMessage(value,proto.scanoss.api.components.v2.CompStatistic.Language.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.scanoss.api.components.v2.CompStatistic.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.scanoss.api.components.v2.CompStatistic} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatistic.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTotalSourceFiles();
  if (f !== 0) {
    writer.writeInt32(
      1,
      f
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.scanoss.api.components.v2.CompStatistic.Language.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.toObject = function(opt_includeInstance) {
  return proto.scanoss.api.components.v2.CompStatistic.Language.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.scanoss.api.components.v2.CompStatistic.Language} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatistic.Language.toObject = function(includeInstance, msg) {
  var f, obj = {
name: jspb.Message.getFieldWithDefault(msg, 1, ""),
files: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.scanoss.api.components.v2.CompStatistic.Language}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.scanoss.api.components.v2.CompStatistic.Language;
  return proto.scanoss.api.components.v2.CompStatistic.Language.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.scanoss.api.components.v2.CompStatistic.Language} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.scanoss.api.components.v2.CompStatistic.Language}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.scanoss.api.components.v2.CompStatistic.Language.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.scanoss.api.components.v2.CompStatistic.Language} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatistic.Language.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.scanoss.api.components.v2.CompStatistic.Language} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional int32 files = 2;
 * @return {number}
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.getFiles = function() {
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatistic.Language} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.Language.prototype.setFiles = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional int32 total_source_files = 1;
 * @return {number}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.getTotalSourceFiles = function() {
...
/**
 * @param {number} value
 * @return {!proto.scanoss.api.components.v2.CompStatistic} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.setTotalSourceFiles = function(value) {
 ...
 * @return {number}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.getTotalLines = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatistic} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.setTotalLines = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional int32 total_blank_lines = 3;
 * @return {number}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.getTotalBlankLines = function() {
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatistic} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.setTotalBlankLines = function(value) {
 ...
 * @return {!Array<!proto.scanoss.api.components.v2.CompStatistic.Language>}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.getLanguagesList = function() {
  return /** @type{!Array<!proto.scanoss.api.components.v2.CompStatistic.Language>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.scanoss.api.components.v2.CompStatistic.Language, 4));
};


/**
 * @param {!Array<!proto.scanoss.api.components.v2.CompStatistic.Language>} value
 * @return {!proto.scanoss.api.components.v2.CompStatistic} returns this
*/
proto.scanoss.api.components.v2.CompStatistic.prototype.setLanguagesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};


/**
 * @param {!proto.scanoss.api.components.v2.CompStatistic.Language=} opt_value
 * @param {number=} opt_index
 * @return {!proto.scanoss.api.components.v2.CompStatistic.Language}
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.addLanguages = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.scanoss.api.components.v2.CompStatistic.Language, opt_index);
};
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatistic} returns this
 */
proto.scanoss.api.components.v2.CompStatistic.prototype.clearLanguagesList = function() {
 ...
 * @const
 */
proto.scanoss.api.components.v2.CompStatisticResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.scanoss.api.components.v2.CompStatisticResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatisticResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
purlsList: jspb.Message.toObjectList(msg.getPurlsList(),
    proto.scanoss.api.components.v2.CompStatisticResponse.Purls.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.scanoss.api.components.v2.CompStatisticResponse;
  return proto.scanoss.api.components.v2.CompStatisticResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.scanoss.api.components.v2.CompStatisticResponse.Purls;
      reader.readMessage(value,proto.scanoss.api.components.v2.CompStatisticResponse.Purls.deserializeBinaryFromReader);
      msg.addPurls(value);
      break;
    case 2:
 ...
 * @return {!Uint8Array}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.scanoss.api.components.v2.CompStatisticResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatisticResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.scanoss.api.components.v2.CompStatisticResponse.Purls.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f != null) {
 ...
 * @return {!Object}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.toObject = function(opt_includeInstance) {
  return proto.scanoss.api.components.v2.CompStatisticResponse.Purls.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.toObject = function(includeInstance, msg) {
  var f, obj = {
purl: jspb.Message.getFieldWithDefault(msg, 1, ""),
version: jspb.Message.getFieldWithDefault(msg, 2, ""),
statistics: (f = msg.getStatistics()) && proto.scanoss.api.components.v2.CompStatistic.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.scanoss.api.components.v2.CompStatisticResponse.Purls;
  return proto.scanoss.api.components.v2.CompStatisticResponse.Purls.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.scanoss.api.components.v2.CompStatistic;
      reader.readMessage(value,proto.scanoss.api.components.v2.CompStatistic.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.scanoss.api.components.v2.CompStatisticResponse.Purls.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPurl();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.scanoss.api.components.v2.CompStatistic.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.getPurl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} returns this
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.setPurl = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.getVersion = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} returns this
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.setVersion = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional CompStatistic statistics = 3;
 * @return {?proto.scanoss.api.components.v2.CompStatistic}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.getStatistics = function() {
  return /** @type{?proto.scanoss.api.components.v2.CompStatistic} */ (
    jspb.Message.getWrapperField(this, proto.scanoss.api.components.v2.CompStatistic, 3));
};


/**
 * @param {?proto.scanoss.api.components.v2.CompStatistic|undefined} value
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} returns this
*/
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.setStatistics = function(value) {
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls} returns this
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.clearStatistics = function() {
 ...
 * @return {boolean}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.Purls.prototype.hasStatistics = function() {
 ...
 * @return {!Array<!proto.scanoss.api.components.v2.CompStatisticResponse.Purls>}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.getPurlsList = function() {
  return /** @type{!Array<!proto.scanoss.api.components.v2.CompStatisticResponse.Purls>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.scanoss.api.components.v2.CompStatisticResponse.Purls, 1));
};


/**
 * @param {!Array<!proto.scanoss.api.components.v2.CompStatisticResponse.Purls>} value
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse} returns this
*/
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.setPurlsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls=} opt_value
 * @param {number=} opt_index
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse.Purls}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.addPurls = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.scanoss.api.components.v2.CompStatisticResponse.Purls, opt_index);
};
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse} returns this
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.clearPurlsList = function() {
 ...
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.getStatus = function() {
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse} returns this
*/
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.setStatus = function(value) {
 ...
 * @return {!proto.scanoss.api.components.v2.CompStatisticResponse} returns this
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.clearStatus = function() {
 ...
 * @return {boolean}
 */
proto.scanoss.api.components.v2.CompStatisticResponse.prototype.hasStatus = function() {
